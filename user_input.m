...
dataSource = 'amsrSST'; % Default is 'satellite'.
...
NUM_LEVELS_M = 12; % Total number of levels. Set to be a natural number. Default is 9.
...
nLevelsInSerial = 2; % Number of levels to compute in serial. Default is ??.
