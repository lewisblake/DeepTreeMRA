...
spmd(NUM_WORKERS)
    for iRow = 1 :  4%nTotalRegionsAssignedToEachWorker
        ...
        [~, indexAncestryInIndexMatrix] = ismember(indexMatrix(1:iRow, labindex), indexAncestry);
        indexAncestryInIndexMatrix = nonzeros(indexAncestryInIndexMatrix); % keep only nonzeros which correspond to the indices of indexAncestry in indexMatrix    
